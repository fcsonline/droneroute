...
export function AccountSettings({ onRequestAuth }: AccountSettingsProps) {
    ...
    return (
      <div className="flex flex-col items-center gap-3 py-6 text-center">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">Sign in to manage your account and save missions</p>
        </div>
        <Button size="sm" onClick={onRequestAuth} className="mt-1">
          Sign in
        </Button>
      </div>
    );
