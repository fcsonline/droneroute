...
Sign up and log in to save your missions and access them from anywhere.
...
- **Use the app without an account** (guest mode) — you can plan flights, but you can't save them.
